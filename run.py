...
def welcome():
    ...
    print("             1   2   3   4   5   6   7  ")
    print("                                        ")
    print("           | . | . | . | . | . | . | \033[0;31;40mO\033[0;32;40m |")
    print("           | . | . | . | . | . | \033[0;31;40mO\033[0;32;40m | X |")
    print("           | O | X | . | . | \033[0;31;40mO\033[0;32;40m | X | O |")
    print("           | X | X | X | \033[0;31;40mO\033[0;32;40m | X | O | O |")
    print("")
    sleep(DELAY_TIME)
        ...
        for x in range(board_width - 3):
            if board_db[x][y] == disc and board_db[x+1][y] == disc:
                if board_db[x+2][y] == disc and board_db[x+3][y] == disc:
                    board_db[x][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+1][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+2][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+3][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    return True
        ...
        for y in range(1, (board_height - 3)):
            if board_db[x][y] == disc and board_db[x][y+1] == disc:
                if board_db[x][y+2] == disc and board_db[x][y+3] == disc:
                    board_db[x][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x][y+1] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x][y+2] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x][y+3] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    return True
        ...
        for y in range(4, board_height):
            if board_db[x][y] == disc and board_db[x+1][y-1] == disc:
                if board_db[x+2][y-2] == disc and board_db[x+3][y-3] == disc:
                    board_db[x][y] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+1][y-1] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+2][y-2] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    board_db[x+3][y-3] = "\033[0;31;40m"+disc+"\033[0;32;40m"
                    return True
